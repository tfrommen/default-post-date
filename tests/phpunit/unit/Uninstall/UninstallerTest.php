...
namespace tfrommen\Tests\DefaultPostDate\Uninstall;

use Mockery;
use tfrommen\DefaultPostDate\Setting\Option;
use tfrommen\DefaultPostDate\Uninstall\Uninstaller as Testee;
...
class UninstallrTest extends TestCase {
	...
	/**
	 * @covers       tfrommen\DefaultPostDate\Uninstall\Uninstaller::uninstall
	...
	public function test_uninstall( $is_multisite, $blog_ids ) {
		...
		/** @var Updater $updater */
		$updater = Mockery::mock( 'tfrommen\DefaultPostDate\Update\Updater' )
